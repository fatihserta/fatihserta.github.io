...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Previous and ongoing projects.",
          section: "Navigation",
          handler: () => {
          ...
          title: "teaching",
          description: "List of courses I&#39;ve been teaching partly",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-environmental-impact-of-cold-seeps-in-biogeochemical-cycles",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%66%61%74%69%68%73%65%72%74%61@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/fatihserta", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/muhammed-fatih-sert-9b2987337", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=87LMIAoAAAAJ", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/mf_sert", "_blank");
        },
      },{
      id: 'light-theme',
